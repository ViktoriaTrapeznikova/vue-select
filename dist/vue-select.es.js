...
import { openBlock as a, createElementBlock as h, createElementVNode as u, resolveDirective as j, normalizeClass as A, renderSlot as r, normalizeProps as d, guardReactiveProps as c, Fragment as B, renderList as L, createTextVNode as v, toDisplayString as D, createBlock as b, resolveDynamicComponent as _, createCommentVNode as O, mergeProps as k, toHandlers as K, withDirectives as w, vShow as P, createVNode as $, Transition as R, withCtx as z, withModifiers as F } from "vue";
const U = {
  props: {
    autoscroll: {
      type: Boolean,
...
https://vue-select.org/api/props.html#getoptionkey`, e, t);
  ...
  computed: {
    ...
    filteredOptions() {
      let e = [];
      if (this.filterable) {
        if (e = [].concat(this.optionList), !this.taggable)
          return e;
      ...
      if (e = this.optionList, this.taggable && this.search.length) {
        const t = this.createOption(this.search);
        e = e.filter((s) => Object.keys(s).length > 1 || s.label === this.search || s === this.search), e.unshift(t);
      }
      return e;
    },
    isValueEmpty() {
  ...
  methods: {
    ...
    findOptionFromReducedValue(e) {
      ...
      return s.length === 1 ? s[0] : s.find((l) => this.optionComparator(l, this.$data._value)) || e;
    },
    closeSearchOptions() {
    ...
    onSearchKeyDown(e) {
      ...
      this.selectOnKeyCodes.forEach((n) => s[n] = t);
    ...
    u("div", {
      ...
      u("div", ue, [
        ...
        r(e.$slots, "search", d(c(i.scope.search)), () => [
          u("input", k({ class: "vs__search" }, i.scope.search.attributes, K(i.scope.search.events)), null, 16)
        ])
      ], 512),
      u("div", fe, [
        w(u("button", {
